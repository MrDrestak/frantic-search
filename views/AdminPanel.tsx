...
import { configService, auth } from '../services/store';
        ...
        <div className="p-4 md:p-8 space-y-6 pb-24">
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6">
                ...
                <p className="text-sm text-slate-400 mb-4">
                    For demonstration purposes, you are currently viewing this as an Admin because your user profile has `isAdmin: true`.
                </p>
                <div className="p-4 bg-slate-950 rounded border border-slate-800 font-mono text-xs text-green-400">
                    Current Config ID: settings/global
                </div>
            </div>
        </div>
    );
