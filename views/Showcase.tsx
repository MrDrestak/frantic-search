...
const Showcase: React.FC<ShowcaseProps> = ({ onViewProfile }) => {
  ...
  const loadShowcase = async () => {
      ...
      try {
          ...
          console.error("Error loading showcase", e);
      } finally {
  ...
  const filteredItems = items.filter(item => {
      if (gameFilter) {
          ...
          if (itemGame !== gameFilter) return false;
      }
  ...
  if (loading) {
      return <PremiumLoading text="Descubriendo tesoros" subtext="Escaneando el Showcase comunitario..." color="rose" />;
  }
